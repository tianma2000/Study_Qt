...
#include <memory>
#include "../../../linux_-qt/title/Goldreverse_2/chooselevelscene.h"
...
QT_MOC_LITERAL(1, 17, 17), // "chooseBackCenario"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 16), // "sotsPlaytoCloose"
QT_MOC_LITERAL(4, 53, 12), // "sotsGotoNext"
QT_MOC_LITERAL(5, 66, 5) // "index"

    },
    "chooselevelscene\0chooseBackCenario\0\0"
    "sotsPlaytoCloose\0sotsGotoNext\0index"
};
...
void chooselevelscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->chooseBackCenario(); break;
        case 1: _t->sotsPlaytoCloose(); break;
        case 2: _t->sotsGotoNext((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&chooselevelscene::chooseBackCenario)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void chooselevelscene::chooseBackCenario()
{
